...
class DoctorController {
    ...
    static async createPosition(req, res, next) {
        try {
            const position = await DoctorService.createPosition(req.body);
    ...
    static async getAllPositions(req, res, next) {
        try {
            ...
            const positions = await DoctorService.getAllPositions(status);
    ...
    static async getPositionById(req, res, next) {
        try {
            const { id } = req.params;
            const position = await DoctorService.getPositionById(id);
    ...
    static async updatePosition(req, res, next) {
        try {
            const { id } = req.params;
            const position = await DoctorService.updatePosition(id, req.body);
    ...
    static async deletePosition(req, res, next) {
        try {
            const { id } = req.params;
            await DoctorService.deletePosition(id);
