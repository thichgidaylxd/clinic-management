    ...
    useEffect(() => {
        if (user) {
            setFormData({
                ...
                ho_nguoi_dung: user.ho_nguoi_dung || '',
                ten_dang_nhap_nguoi_dung: user.ten_dang_nhap_nguoi_dung || '',
                email_nguoi_dung: user.email_nguoi_dung || '',
                so_dien_thoai_nguoi_dung: user.so_dien_thoai_nguoi_dung || '',
                mat_khau_nguoi_dung: '',
                gioi_tinh_nguoi_dung: user.gioi_tinh_nguoi_dung ?? 0,
                ma_vai_tro: user.ma_vai_tro || '',
                trang_thai_nguoi_dung: user.trang_thai_nguoi_dung ?? 1
            });
        }
    }, [user]);
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <select
                                ...
                                onChange={(e) => setFormData({ ...formData, ma_vai_tro: e.target.value })}
                                className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-teal-700 focus:outline-none"
                            >
                        ...
                        <div>
                            ...
                            <select
                                value={formData.trang_thai_nguoi_dung}
                                onChange={(e) => setFormData({ ...formData, trang_thai_nguoi_dung: parseInt(e.target.value) })}
                                className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-teal-700 focus:outline-none"
                            >
